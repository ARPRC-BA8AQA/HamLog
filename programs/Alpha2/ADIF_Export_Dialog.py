...
class ADIFExportDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.cmb_format.addItem("标准 ADIF (通用)", "standard")
        self.cmb_format.addItem("LoTW 格式", "lotw")
        options_layout.addRow("文件格式:", self.cmb_format)

        # 呼号
        self.txt_callsign = QLineEdit()
        self.txt_callsign.setPlaceholderText("你的呼号，如 BD8FPH")
