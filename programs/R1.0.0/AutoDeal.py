...
class SettingsManager:
    ...
    def _init_settings_table(self):
        ...
        defaults = {
            ...
            # === 新增：网络延迟设置 ===
            'intertime_enabled': '1',
            'intertime_nodes': 'www.baidu.com',
            'intertime_timeout': '2',
            'intertime_interval': '5',
            'intertime_display_names': '',
            # === 新增：界面设置默认值 ===
            'table_row_height': '28',
            'table_font_size': '10',
            'show_id_column': '0',
            ...
            'proxy_https': '',
            'proxy_socks5': '',
            'proxy_no_proxy': 'localhost,127.0.0.1,::1,gitee.com,ghproxy.com,ghproxy.net,mirror.ghproxy.com',
            'proxy_use_system': '0',
        }
